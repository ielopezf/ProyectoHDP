...
public interface MateriaRepository extends JpaRepository<Materia, Long> {
   ...
   List<Object> getMaterias();
    ...
    @Query(value = "Select m.codigo as codigo, m.nombre as nombre, u.carnet as carnet , u.nombre as nombre_alumn from Materia m, Usuario u where u.id = :id_docente and m.docente = u.id")
